...
import { property, LitElement, customElement, html, state, query } from '../../../_snowpack/pkg/lit-element.js';
...
__decorate([
    state()
], OscdEditor.prototype, "workflow", void 0);
__decorate([
    query('wizard-dialog')
], OscdEditor.prototype, "wizardUI", void 0);
