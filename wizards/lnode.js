...
import { find, getValue, identity, isPublic, newWizardEvent, referencePath, newLnInstGenerator, } from '@openscd/open-scd/src/foundation.js';
import { cloneElement, createElement, getChildElementsByTagName, } from '@openscd/xml';
